	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview">
				...
				<ul class="treeview-menu">
					<li><a href="{{route('backend.products.index')}}"><i class="fa fa-circle-o"></i> {{transa('list')}}</a></li>
					<li><a href="{{route('backend.products.create')}}"><i class="fa fa-circle-o"></i> {{transa('add')}}</a></li>
				</ul>
			</li>
			<li class="header"></li>
		</ul>
