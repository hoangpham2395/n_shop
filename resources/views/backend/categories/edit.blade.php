...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="{{route('backend.categories.index')}}">{{transa('categories.name')}}</a></li>
		...
		<div class="col-xs-12">
			...
			<div class="box box-danger">
				<div class="box-header">
					<h3 class="box-title">{{transa('categories.edit')}}</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					{!! Form::model($entity, ['route' => ['backend.categories.update', $entity->id], 'method' => 'PATCH']) !!}
